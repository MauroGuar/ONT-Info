...
from app.data_processing.ont_info import new_request
...
def buscar():
    if request.method == "POST":
        ...
        date, time, dictionary_to_show = new_request(olt_ip, ont_sn, items_to_show=items_to_show, debug_mode=True)
